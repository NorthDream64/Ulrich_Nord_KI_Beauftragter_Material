...
| https://digital-strategy.ec.europa.eu/en/library/draft-commission-guidelines-classification-high-risk-ai-systems | **Draft Commission guidelines on the classification of high-risk AI systems** (Europäische Kommission) | Primärquelle, Tier 1 — **⚠️ ENTWURF** | Veröffentlicht 19.05.2026, zuletzt aktualisiert 23.07.2026. Auslegung der Kommission zu **Art. 6 KI-VO** samt **praktischen Beispielen** für hochriskante und nicht hochriskante Systeme (gemäß Art. 6 Abs. 5). Aufbau folgt Art. 6: **Abschnitt III** = Art. 6 Abs. 1 (Sicherheitsbauteil oder Produkt nach Anhang-I-Harmonisierungsrecht mit Drittkonformitätsbewertung); **Abschnitt IV** = Art. 6 Abs. 2 (Anwendungsfälle nach Anhang III). **Drei separat abrufbare Teildokumente:** Allgemeine Grundsätze · Anhang I · Anhang III — für den Unterricht kann der Anhang-III-Teil allein ausgegeben werden. **Zwingender Vorbehalt:** Entwurf in laufender Verbändekonsultation, **nicht bindend**; Beispiele ausdrücklich **nicht abschließend** und änderbar. Im Kurs als „aktuelle Auffassung der Kommission, Stand Juli 2026" kennzeichnen, nie als geltende Auslegung. Adressiert sind Anbieter, Betreiber **und Marktüberwachungsbehörden**; KIB Tag 3 (Dreistufenmodell), Tag 4 (Risikoklassen — primär), Tag 6 |
...
| https://www.bmi.bund.de/SharedDocs/downloads/DE/publikationen/themen/it-digitalpolitik/BMI24014.pdf?__blob=publicationFile&v=3 | BMI — „KI-Leitbild für das Ressort BMI" (20.06.2024, PDF ca. 2 MB, barrierefrei) | Behörde, Tier 1 — **Musterdokument, nicht Rechtsstand** | Ressortinternes Leitbild des Bundesinnenministeriums für den Umgang mit KI in der öffentlichen Verwaltung; entstanden als Pilotvorhaben der **BeKI** (Beratungsstelle für Künstliche Intelligenz), der zentralen Anlauf- und Koordinierungsstelle für KI-Vorhaben der Bundesverwaltung. Berichtete Handlungsfelder: Prozessoptimierung, Mitarbeiterunterstützung, Resilienz der Bundesverwaltung, Informationszugang, Ressourcenschutz. **⚠️ Zwei Vorbehalte:** (1) **Stand Juni 2024** — vor Anwendbarkeit der KI-VO-Fristen, vor dem KI-MIG, vor der agentischen Entwicklung; **inhaltlich veraltet, als Aussage über die Rechtslage unbrauchbar**. (2) Ressortintern, keine allgemeine Vorgabe. **Wofür es taugt:** als **öffentlich zugängliches Beispiel dafür, wie eine große Organisation ihr KI-Leitbild formuliert** — solche Dokumente sind sonst selten öffentlich. Verwendbar als Formatvorlage bei der internen Nutzungsrichtlinie (KIB Tag 8) und für Teilnehmende aus dem öffentlichen Dienst (BeKI als zuständige Stelle). Kursmaterialien: bislang nicht eingebaut |
...
| https://oecd.ai/ | OECD AI Policy Observatory (OECD.AI) | Zwischenstaatliche Organisation, Tier 1 | Dachportal für alle KI-Aktivitäten der OECD; drei Bausteine: **AI Incidents Monitor (AIM)** — Sammlung realer KI-Vorfälle aus der internationalen Presse (siehe 3.1) · **Catalogue of Tools & Metrics for Trustworthy AI** — praktische Umsetzungsinstrumente, anschlussfähig an ISO 42001 · **Policy Observatory** — Länderpolitiken im Vergleich. **Definitionsbezug:** Die Definition des KI-Systems in Art. 3 Nr. 1 EU AI Act folgt der 2023 überarbeiteten OECD-Definition sehr eng; abweichend formuliert der AI Act die Anpassungsfähigkeit als *möglich* („may exhibit adaptiveness") statt als zwingend — vor Verwendung im Unterricht an den Primärtexten gegenlesen (EU-Kommission, AI Act Service Desk, Art. 3). **Vorbehalt:** Das Portal wird derzeit wegen der Integration der Global Partnership on AI (GPAI) umgebaut — Tiefenlinks können brechen, daher Portalwurzel zitieren |
...
| https://www8.cao.go.jp/cstp/ai/ai_plan/ai_plan.html | 人工知能基本計画 — Japans KI-Grundlagenplan (Cabinet Office / 内閣府) | Regierung, Tier 1 | Japan, G7. **Zweite Fassung: Kabinettsbeschluss 14.07.2026**; erste Fassung 23.12.2025 — beide auf der Seite abrufbar, **jeweils mit amtlicher englischer Übersetzung** (Übersicht `aiplan_g_eng_20260714.pdf`, Volltext `aiplan_eng_20260714.pdf`). Vier Säulen: Adopt AI · Create AI · Enhance AI Trustworthiness · Collaborate with AI. Schlüsselbegriffe: **agentische KI als Prämisse der Nationalstrategie** · **„AI Sovereignty"** (offen, zugleich strategische Autonomie und strategische Unentbehrlichkeit) · **„responsible agile governance"** (laufende Überprüfung der Gesetze statt festgeschriebener Regulierung) · Vertical AI und Physical AI als strategische Schwerpunkte · „people skills and humanness" als Politikziel · AISI-Stärkung. **Besonderheit: ausdrücklich zur jährlichen Fortschreibung angelegt.** Nützlich als sachlicher Gegenentwurf zum EU-Regulierungsmodell; KIB Tag 5 (Rechtsvergleich), KIM Tag 10 (Agenten, Build vs. Buy), MAT |
...
| https://huggingface.co/ | Hugging Face | Plattform | Sammelplattform für KI-Modelle (Model Hub), Datensätze, Demo-Umgebungen (Spaces); führende Anlaufstelle für Open-Source- und Open-Weight-LLMs (Llama, Mistral, DeepSeek u.a.); Leaderboards für Modellvergleiche |
...
| https://cdr-initiative.de/initiative | CDR-Initiative des Bundesjustizministeriums — Trägerschaft, Mitglieder, Selbstverständnis | Behörde/Initiative | Corporate Digital Responsibility, gegründet Mai 2018 durch das BMJV, zwischenzeitlich BMUV, seit 2025 wieder BMJV; Mitglieder u. a. Telekom, Otto Group, Zalando, ING, Telefónica, BARMER; Quick-Check und Reifegradmodell; **zugleich Interessenträgerin — belastbar für die Verankerung des Begriffs, nicht für die Wirksamkeit**; KIM Tag 14 |
| https://cdr-initiative.de/kodex | CDR-Kodex — neun Prinzipien und fünf Handlungsfelder | Selbstverpflichtung | Prinzipien: Grundwerte, Menschenzentrierung, Nutzen, Schadensvermeidung, Autonomie, Fairness, Transparenz, Verantwortlichkeit (benannte menschliche Verantwortungsträger), Nachhaltigkeit; Handlungsfelder: Umgang mit Daten, Bildung, Klima- und Ressourcenschutz, Mitarbeitenden-Einbindung, Inklusion; Berichtspflicht zu jedem Ziel; KIM Tag 14 |
...
| https://oecd.ai/en/incidents/2026-07-15-c037 | OECD AI Incidents Monitor — Rücktritt bei Google DeepMind wegen des Pentagon-Abkommens (Juni 2026) | Behörde | Zwischenstaatlich, Abgänge aus Ethik-/Sicherheitsfunktionen, militärische Nutzung, fehlende Schutzklauseln; KIM Tag 14. **Einzeleintrag aus dem AI Incidents Monitor** — Werkzeug siehe 3.1, Portal siehe 1.1. Der Eintrag selbst referenziert Presseberichterstattung und ist daher nicht automatisch Tier 1; Belegstärke nach der dahinterliegenden Primärquelle beurteilen |
| https://www.forbes.com/sites/conormurray/2026/02/09/anthropic-ai-safety-researcher-warns-of-world-in-peril-in-resignation/ | Forbes — Rücktritt des Leiters der Safeguards-Forschung bei Anthropic (Februar 2026) | Fachmedium | Abgangswelle Ethik/Sicherheit, Druck auf Sicherheitsteams, Bioterrorismus-Abwehr, Sycophancy; KIM Tag 14 |
| https://www.fortune.com/2023/03/14/microsofts-a-i-ethics-layoffs-send-a-worrying-signal | Fortune — Auflösung des Ethics-and-Society-Teams bei Microsoft (März 2023) | Fachmedium | Normsetzung bleibt, Normanwendung wird gestrichen; Office of Responsible AI blieb bestehen; KIM Tag 14 |
| https://www.cnbc.com/2023/11/18/facebook-parent-meta-breaks-up-its-responsible-ai-team.html | CNBC — Auflösung des Responsible-AI-Teams bei Meta (November 2023) | Fachmedium | Verteilung in die Produktentwicklung generativer KI; KIM Tag 14 |
| https://ethicalaidepartures.fyi/ | Ethical AI Departures — Tracker dokumentierter Abgänge | NGO/Tracker | Tier 3, aber sauber typisierte Belegstufen (explizit erklärt / berichtet / Vorwurf / nur Kontext); **nur zur Fallrecherche, nicht als Beleg im Hand-Out**; KIM Tag 14 |
...
| https://oecd.ai/en/incidents | OECD AI Incidents Monitor (AIM) | Zwischenstaatliche Organisation, Tier 1 | Durchsuchbare Sammlung realer KI-Vorfälle aus der internationalen Presse; **Fundstelle für Fallstudien** — KIB Tag 4 (Fallstudien), Tag 9/10 (Risikomanagement), Tag 12 (Qualitätssicherung); KIM Tag 14. **Wichtiger Belegvorbehalt:** AIM sammelt *Presseberichte*, keine geprüften Feststellungen. Der Katalog als Institution ist Tier 1 — die einzelnen Einträge sind es **nicht**. Ein AIM-Eintrag ist ein Fundhinweis auf Berichterstattung; die Belegstärke richtet sich nach der dahinterliegenden Primärquelle (vgl. Belegskala A–D, KIM Tag 5). Portalwurzel: siehe 1.1 |
...
| https://aiinstitute.hbs.edu/is-ai-making-your-team-lazy/ | Dell'Acqua — Falling Asleep at the Wheel (Feldversuch, 181 Personalfachleute, ~8.000 Lebensläufe) | Feldstudie | Bessere KI → schlechtere Ergebnisse; vier Qualitätsstufen (99/85/75/keine); schwache KI hält wachsam; Override-Rate nahe null als Warnsignal; Einordnung durch das AI Institute der Harvard Business School; KIM Tag 14 |
...
| https://doku.iab.de/kurzber/2026/kb2026-08.pdf | **IAB-Kurzbericht 8/2026 — „Jeder vierte Betrieb nutzt mittlerweile generative KI"** (Friedrich & Kagerl, 05.05.2026) | **Primärquelle, höchste Belegstufe** | **Belastbarste deutsche Datenbasis zur KI-Verbreitung.** IAB-Betriebspanel, rund 15.000 Betriebe, Erhebung Juli–November 2025, CC BY-SA 4.0. Verbreitung 5 % (2023) → 24 % (2025), +9 % geplant · nach Größe 21 % (1–9 MA) bis 48 % (200+) · nach Branche Information/Kommunikation 59 %, Finanz/Versicherung 50 %, Primärsektor 9 % · **90 % nutzen frei zugängliche Modelle**, 6 % eigene · 45 % haben investiert · **Weiterbildung: 27 % vorhanden, 21 % geplant, 52 % weder noch** · **Interne Regeln: 21 % vorhanden, 22 % geplant, 56 % weder noch** · ältere, nicht-generative KI nur 6 % · Deutschland international im Mittelfeld. **Vorbehalte der Autoren:** statistische Zusammenhänge, keine Kausalität; Betriebsangaben sind eine Untergrenze. KIB Tag 14 (eingebaut) · KIM Tag 5 möglich |
| https://job-futuromat.iab.de/ | **Job-Futuromat** (IAB) | Interaktives Werkzeug | Tätigkeitsbezogene Automatisierbarkeit je Beruf, rund 8.000 BERUFENET-Tätigkeiten, je Tätigkeit von drei Codiererinnen unabhängig bewertet. Kostenlos, Leichte Sprache und Gebärdensprache. **⚠️ PFLICHTANGABE bei jeder Verwendung: Stand der Technik 2022** — also vor allgemeiner Verfügbarkeit generativer KI. Das IAB stellt ausdrücklich klar, dass **keine Prognose** abgegeben wird. Unterschätzt systematisch bei Büro- und Wissensarbeit, bei handwerklichen Berufen grob belastbarer. **Nicht als Zahlenquelle verwenden — als Kalibrierungsübung.** Methodische Grundlage: IAB-Kurzbericht 5/2024 (Grienberger, Matthes & Paulus). KIB Tag 13 (eingebaut) |
...
| https://dl.acm.org/doi/abs/10.1287/orsc.1070.0270 | Stahl & Voigt — Do Cultural Differences Matter in Mergers and Acquisitions? (Organization Science 19(1), 2008) | Metaanalyse | Tier 1, peer-reviewed; 46 Studien, über 10.000 Zusammenschlüsse; Kulturunterschiede wirken nicht durchgängig negativ, können Quelle von Wertschöpfung und Lernen sein; entscheidend ist der Umgang, nicht der Abstand; KIM Tag 15 |
| https://mbs.edu/faculty-and-research/trust-and-ai | Gillespie, Lockey, Ward, Macdade & Hassed (2025) — Trust, attitudes and use of artificial intelligence: A global study 2025 (University of Melbourne und KPMG, DOI 10.26188/28822919) | Studie | Tier 1–2; n = 48.340 in 47 Ländern, Erhebung 11/2024–01/2025, repräsentativ, Landessprachen mit Rückübersetzung, IMF-Klassifikation Schwellen-/Industrieländer; **Vorbehalte:** von KPMG mitfinanziert (Auswertung eigenständig durch Universitätsteam), Befragte bekamen zufällig einen von vier Anwendungsfällen zugewiesen; Kennzahlen: global 66 % Nutzung / 46 % Vertrauen; Schwellenländer 3 von 5 vs. Industrieländer 2 von 5; Kompetenz 64/46, Schulung 50/32, Nutzen 82/65; Beschäftigte: 57 % verbergen Nutzung, ~50 % gegen Richtlinien, 66 % ungeprüft, 56 % Fehler, 47 % geschult, 40 % Richtlinie; KIM Tag 15, Tag 14 |
| https://www.ipsos.com/sites/default/files/ct/news/documents/2026-06/Ipsos-AI-Monitor-2026.pdf | Ipsos AI Monitor 2026 — 32-Länder-Studie | Studie (Marktforschung) | Tier 2; n = 23.532 Erwachsene unter 75 Jahren in 32 Ländern, Feldzeit 20.03.–03.04.2026; Frageformulierung: „Produkte und Dienstleistungen, die künstliche Intelligenz nutzen, haben mehr Vorteile als Nachteile"; **Länderwerte:** China 83 %, Indonesien 80 %, Thailand 77 % — Kanada 40 %, USA 39 %, Niederlande 36 % (niedrigster Wert im Feld); **Vorbehalt:** kommerzielles Marktforschungsinstitut, kein Peer Review, Methodik aber offengelegt; **wichtig:** Diese Werte werden vielfach als „Stanford-Zahlen" weitergereicht — Stanford HAI übernimmt sie lediglich im AI Index, erhoben hat sie Ipsos. Immer Ipsos als Erhebung nennen. Nicht verwechseln mit der zweiten Frage („KI wird mein Leben in 3–5 Jahren tiefgreifend verändern", >80 % in China/Malaysia/Thailand/Indonesien/Singapur); KIM Tag 15 |
...
> **Stand: 06.09.2026 · nächste Prüfung: März 2027.** Dieses Kapitel altert schneller als jedes andere im Register — Zuständigkeiten werden derzeit in mehreren Staaten erst geschaffen. Vor jeder Verwendung im Unterricht das Stand-Datum prüfen.
>
...
| https://digital-strategy.ec.europa.eu/en/policies/enforcement-ai-act | Kommission — Durchsetzungsrahmen der KI-VO | **Maßgebliche Primärquelle zum Sanktionsregime.** Zuständigkeitsverteilung (KI-Büro / EDSB / nationale Behörden), Auskunftsersuchen als einfaches Ersuchen oder per Beschluss, Modellbewertungen und Zugangsersuchen, Bußgeldrahmen, Fristenübersicht. Stand der Seite prüfen — sie wird laufend fortgeschrieben | AI Act enforcement framework requests for information penalties AI Office |
| https://digital-strategy.ec.europa.eu/en/policies/code-practice-ai-generated-content | Kommission — Code of Practice on Transparency of AI-generated Content | Freiwilliger Kodex zu Art. 50 Abs. 2, 4, 5; veröffentlicht 10.06.2026; zwei Abschnitte (Anbieter / Betreiber); von Kommission und KI-Ausschuss als geeignetes Nachweismittel bestätigt; rund 190 Unterzeichner bis Ende Juli 2026 | Code of Practice transparency AI-generated content marking labelling |
...
| https://www.nist.gov/artificial-intelligence/ai-congressional-mandates-executive-orders-and-actions | 🇺🇸 NIST — Mandate und Erlasse | **Aktualitätsprüfung für alle NIST-Zitate.** Die Executive Order 14110 (30.10.2023) ist dort als **„[Rescinded 1/20/2025]"** vermerkt. Aktuelles Politikdokument ist „Winning the Race: America's AI Action Plan" (23.07.2025) | NIST congressional mandates executive orders AI Action Plan |
...
| https://www.law.go.kr/lsInfoP.do?lsiSeq=268543 | 🇰🇷 **KI-Grundgesetz** | 인공지능 발전과 신뢰 기반 조성 등에 관한 기본법, **Gesetz Nr. 20676**, verkündet 21.01.2025, in Kraft **22.01.2026** — das zweite umfassende KI-Gesetz weltweit. Amtlicher Text im Nationalen Rechtsinformationszentrum. Zuständig laut Kopfzeile: MSIT, Referat für KI-Sicherheits- und Vertrauenspolitik | 인공지능기본법 법률 제20676호 국가법령정보센터 |
| https://www.law.go.kr/LSW/lsInfoP.do?efYd=20260122&lsiSeq=282879 | 🇰🇷 Durchführungs&shy;verordnung | **VO Nr. 36053**, 21.01.2026, in Kraft 22.01.2026. Enthält die **Schwellenwerte**: § 24 Sicherheitspflicht ab 10^26 Rechenoperationen — kumulativ mit zwei weiteren Bedingungen; § 29 Inlandsvertreter ab 1 Bio. Won Gesamtumsatz, 10 Mrd. Won KI-Umsatz oder 1 Mio. täglichen Nutzenden — oder nach vorheriger Sanktionierung | 인공지능기본법 시행령 대통령령 제36053호 |
| — | 🇰🇷 **MSIT** | 과학기술정보통신부 — Ministerium für Wissenschaft und IKT. Zuständige Behörde: Untersuchungen, Abhilfeanordnungen, Bußgelder, Bestätigung der Einstufung als Hochwirkungs-KI | Ministry of Science and ICT Korea AI Basic Act enforcement |
| — | 🇰🇷 Nationaler KI-Strategie&shy;ausschuss | 국가인공지능전략위원회 nach § 7 — **beim Präsidenten angesiedelt und von ihm geleitet**, bis zu 60 Mitglieder, auf fünf Jahre befristet. Die Aufsichtsstruktur ist also nicht MSIT allein | 국가인공지능전략위원회 National AI Strategy Committee Korea |
| https://www.aisi.re.kr/eng | 🇰🇷 **Korea AISI** | 인공지능안전연구소 — KI-Sicherheitsinstitut mit **ausdrücklicher gesetzlicher Grundlage in § 12**. Risikodefinition, Bewertungsmaßstäbe, Normung, internationale Zusammenarbeit. Technisches Institut, kein Regulierer | Korea AI Safety Institute 인공지능안전연구소 |
| https://aibasicact.kr/ | 🇰🇷 AI Basic Act Explorer | **Keine Regierungsseite.** Betrieben vom **Future of Life Institute** (US-Nichtregierungsorganisation mit erklärter Position in der Risikodebatte) gemeinsam mit dem Korea AISI. Stellt Gesetz und Verordnung auf Englisch bereit. **Als Übersetzungs- und Auffindungshilfe nützlich, für verbindliche Aussagen gilt der koreanische Text** | Korea AI Basic Act Explorer Future of Life Institute English translation |
